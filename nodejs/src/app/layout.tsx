...
export const metadata: Metadata = {
  title: "Node.js Mastery - Professional Backend Course",
  description: "Master Node.js, Express, and modern backend architecture. Build scalable applications with the world's most popular JavaScript runtime.",
};
