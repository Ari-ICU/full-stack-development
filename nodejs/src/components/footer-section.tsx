  ...
  return (
    <footer className="w-full flex flex-col md:flex-row items-center justify-between gap-8 px-6 md:px-14 py-8 md:py-10 mt-auto border-t border-white/5 bg-black/20">
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-[#1a2e1a] rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
          TR
        </div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-white/80">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-medium">08:00 PM - 09:30 PM</span>
        </div>
        <div className="flex items-center gap-2.5">
          <Video className="text-green-400" size={18} />
          <span className="text-sm font-medium">21+ Modules</span>
        </div>
      </div>

      <Button 
        onClick={onAction}
        className="bg-gradient-to-br from-green-500 to-emerald-700 hover:from-green-600 hover:to-emerald-800 text-white font-bold h-12 px-8 rounded-xl shadow-lg shadow-green-500/20 group"
      >
        Start Learning
