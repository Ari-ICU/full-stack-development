      ...
      <div className="max-w-6xl mx-auto py-10">
        <div className="flex flex-col items-center text-center mb-12 px-6">
          <Badge variant="outline" className="mb-4 border-green-500/30 text-green-400 bg-green-500/10 backdrop-blur-sm px-4 py-1">
            Professional Node.js Curriculum
          </Badge>
          <h2 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tight">
            Backend Mastery from <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-emerald-500">Zero to Scale</span>
          </h2>
          <p className="text-white/80 max-w-2xl text-lg">
            A meticulously designed learning path for building high-performance server-side applications.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 px-6">
          {modules.map((module, index) => (
            ...
            >
              <Card className="h-full bg-white/[0.03] border-white/10 backdrop-blur-md hover:bg-white/[0.07] hover:border-green-500/40 transition-all duration-500 group relative overflow-hidden">
                ...
                <CardContent className="p-6 flex flex-col h-full z-10">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-black text-white/80 tracking-widest uppercase">Module {module.id.toString().padStart(2, '0')}</span>
